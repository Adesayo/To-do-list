...
const newListForm=document.getElementById("newList")
const newListInput=document.querySelector(".new")
const deleteListButton=document.getElementById("listDelete")
...
const newTaskForm=document.getElementById("taskNew")
const newTaskInput=document.getElementById("taskNewValue")
const clearComplete=document.getElementById("listClear")
